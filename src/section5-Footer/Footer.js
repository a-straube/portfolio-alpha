                ...
                <div className="collapse" id="creditsCollapse">
                    <div id="creditsCardBody">
                        <ul id="credits">
                            ...
                            <li>
                                <img src={imgs.pineappleHandRight} alt="Photo by SHVETS production from Pexels" />
                            ...
                            <li>
                                <img src={imgs.coconutHandLeft} alt="Photo by cottonbro studio from Pexels" />
                            ...
                            <li>
                                <img src={imgs.plant1} alt="green plants PNG Designed By chen" />
                            ...
                            <li>
                                <img src={imgs.wave} alt="Painted ocean wave" />
                            ...
                            <li>
                                <img src={imgs.book} alt="book PNG Designed By esenefte" />
